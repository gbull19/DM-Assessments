...
// console.log(canWeDeliver(84057));
...
const newDiscount = (obj, searchValue, newValue) => {
    obj[0].title = obj[0].title.replace(searchValue, newValue);
    return obj;
};
console.log(newDiscount(deals, "15%", "10%"))
...
const newFamilyDeal = (obj, searchValue, newValue) => {
    obj[1].desc = obj[1].desc.trim().replace(searchValue, newValue);
    return obj;
};
console.log(newFamilyDeal(deals, "March", "April"))